...
Usage:
  cd ai-service
  python training/delay/generate_data.py
  python training/delay/generate_data.py --rows 50000
  python training/delay/generate_data.py --kaggle training/data/delay/kaggle_raw.csv
"""
...
SEED = 42
DEFAULT_ROWS = 30_000
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "data" / "delay"
OUTPUT_FILE = OUTPUT_DIR / "supply_chain_delays.csv"
